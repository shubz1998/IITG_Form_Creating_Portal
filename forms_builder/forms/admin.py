...
from forms_builder.forms.models import Form, Field, FormEntry, FieldEntry,User
...
class FormAdmin(admin.ModelAdmin):
    ...
    inlines = (FieldAdmin,)
    list_display = ("user","title", "status", "email_copies", "publish_date",
    ...
    # Filter entries View for form_entries
    # all entries Export for form_entries_show
    # all entries for form_entries_export
